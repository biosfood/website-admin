...
export function Logo() {
  return (
    <svg viewBox={`${-strokeWidth/2} ${-strokeWidth/2} ${200+strokeWidth} ${200+strokeWidth/2}`}
      ...
      <path style={{strokeWidth,strokeLinejoin: 'round', stroke, fill: '#888'}} d="M 50 100 H 200 V 150 A 50 50 0 0 1 150 200 H 50 A 50 50 0 0 1 0 150 V 150 A 50 50 0 0 1 50 100 Z" data-bx-shape="rect 0 100 200 100 50 0 50 50 1@35ee210e"></path>
